        ...
        {type === 'select' ? (
          <select
            ...
            style={{
              width: '100%',
              padding: '12px 14px',
              border: `1.5px solid ${hasValue ? colors.primary : colors.border}`,
              borderRadius: 8,
              fontSize: 14,
              color: colors.text,
            ...
            onBlur={e => {
              (e.target as HTMLElement).style.borderColor = hasValue ? colors.primary : colors.border
            }}
          >
    ...
    <div style={{ maxWidth: '900px', margin: '0 auto', padding: '24px' }}>
      ...
      {success && (
        <Card
          ...
          padding="16px"
          style={{ marginBottom: 24, background: '#e8f5e9', borderLeft: `4px solid ${colors.success}` }}
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <span style={{ fontSize: 20 }}>✅</span>
            <div>
              <div style={{ fontWeight: 600, color: colors.primaryDark }}>FVS criada com sucesso!</div>
      ...
      {/* Form Card */}
      <Card borderColor={colors.primary} padding="32px">
        <form onSubmit={handleSubmit}>
          {/* Seção 1: Identificação */}
          <div style={{ marginBottom: 32, paddingBottom: 24, borderBottom: `2px solid ${colors.border}` }}>
          ...
          <div style={{ marginBottom: 32 }}>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <div
                ...
                onDragLeave={e => {
                  (e.currentTarget as HTMLElement).style.background = colors.bgLight
                }}
                onDrop={e => {
                  e.preventDefault()
                  ;(e.currentTarget as HTMLElement).style.background = colors.bgLight
              ...
              >
                ...
                <label htmlFor="file-input" style={{ cursor: 'pointer' }}>
                  ...
                  <div style={{ fontSize: 14, fontWeight: 600, color: colors.primaryDark, marginBottom: 4 }}>
                    Clique ou arraste fotos aqui
                  </div>
                  <div style={{ fontSize: 12, color: colors.textMuted }}>PNG, JPG até 10MB cada</div>
                </label>
              </div>
              ...
              {formData.fotos.length > 0 && (
                <div style={{ marginTop: 16 }}>
                  <div style={{ fontSize: 12, fontWeight: 600, color: colors.primaryDark, marginBottom: 12 }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(100px, 1fr))', gap: 12 }}>
                    {formData.fotos.map((file, index) => (
                      ...
                      >
                        ...
                        <div style={{ fontSize: 11, color: colors.textMuted, wordBreak: 'break-all', marginBottom: 8 }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <button
              ...
              onMouseEnter={e => {
                if (!loading) (e.target as HTMLElement).style.background = colors.primaryDark
              }}
              onMouseLeave={e => {
                if (!loading) (e.target as HTMLElement).style.background = colors.primary
              }}
            >
            ...
            <button
              ...
              onMouseEnter={e => {
                (e.target as HTMLElement).style.background = colors.bgLight
              }}
              onMouseLeave={e => {
                (e.target as HTMLElement).style.background = colors.border
              }}
            >
              Limpar
            </button>
